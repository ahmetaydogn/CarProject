...
internal class MyLayoutControlImplementor : LayoutControlImplementor
{
    ...
    {
        return base.CreateLayoutItem(parent);
    }
    ...
    public override LayoutGroup CreateLayoutGroup(LayoutGroup parent)
    {
        ...
        grp.OptionsTableLayoutGroup.ColumnDefinitions[0].Width = 240;
        ...
        grp.OptionsTableLayoutGroup.ColumnDefinitions.Add(new ColumnDefinition { SizeType = SizeType.Absolute, Width = 120 });
