...
public partial class CarAddForm : BaseEditForm
{
    ...
    public CarAddForm(int id, EventType _eventType, IContainerControl _baseForm) : this()
    {
    ...
    public override void SendEntityToUpdate()
    {
        ...
        var result = productService.Update(CreateProduct());
        if (result.IsSuccess)
        {
            Messages.SuccessMessage(result.Message);
            Closing();
